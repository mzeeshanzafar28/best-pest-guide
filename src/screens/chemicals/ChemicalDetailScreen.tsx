...
export const ChemicalDetailScreen = ({ navigation }: any) => {
    ...
    return (
        <View style={styles.container}>
            <Header3D title="Chemical Detail" />
            <ScreenWrapper>
                <ContentCard>
                    {chemical.imageUrl && (
                        <Image
                    ...
                    <Text style={styles.title}>{chemical.title}</Text>

                    {isLocked ? (
                        <View style={styles.lockedContainer}>
                            <Text style={styles.lockedTitle}>Premium Content</Text>
                            <Text style={styles.lockedText}>
                                This chemical information is only available to premium subscribers.
                            </Text>
                            <NeumorphicButton
